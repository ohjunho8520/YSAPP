<img width="382" height="667" alt="image" src="https://github.com/user-attachments/assets/b147a52d-a152-4057-9014-e9293aa095b4" />

메인화면: 위에 로그인 버튼을 넣어 로그인,회원가입을 가능하게 만들고 셔틀, 학식, 학사일정 버튼을 넣어놓음.

<img width="384" height="667" alt="image" src="https://github.com/user-attachments/assets/53cebd73-5435-4330-9df3-04823c930b3e" />
...
학식: 학식에 있는 선택사항을 그대로 만들고 각 메뉴마다 메뉴 상세페이지를 만들어서 리뷰작성까지 가능하게 만듬.
...
학사일정: 학교 홈페이지에 있는 학사일정을 참고하여 이번년도에 있는 학사일정을 등록해놓음. 추가로 일정추가 버튼을 눌러서 일정 등록 가능
